...
Project web tương tác cho game show "Sáng Danh Đạo Thầy", viết bằng Vite + JavaScript thuần. Giao diện tối ưu cho trình chiếu 16:9, có các gói câu hỏi, timer 20 giây và hiệu ứng hiện đáp án.
...
- Ở mỗi câu hỏi, bấm `Bắt đầu tính giờ` để chạy timer 20 giây.
